...
return {
  run = function(ctx)
    ...
    check("studio service", studio_new.ok and studio_mode.ok and studio_tool.ok and studio_add.ok and studio_add.data.components[studio_add.data.selected].x == 44 and studio_move.ok and studio_resize.ok and studio_source.ok and studio_line.ok and studio_insert_line.ok and studio_delete_line.ok and studio_icon.ok and studio_scroll_panel.ok and studio_duplicate.ok and studio_nudge.ok and studio_delete.ok and studio_example.ok and studio_diagnostics.ok and studio_diagnostics.data.count == 0 and studio_export.ok and fs.exists(studio_export.data.manifest) and fs.exists(studio_export.data.ui) and studio_export.data.path:match("%.app$") ~= nil)
