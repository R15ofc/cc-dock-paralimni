  ...
  local function build_app_context(app, instance)
    ...
    local app_ctx = {
      ...
      studio_service = {
        ...
        scrollPanel = function(delta, max_offset) return ctx.studio_service.scrollPanel(delta, max_offset) end,
        deleteSelected = function() return ctx.studio_service.deleteSelected() end,
        duplicateSelected = function() return ctx.studio_service.duplicateSelected() end,
        nudgeSelected = function(dx, dy) return ctx.studio_service.nudgeSelected(dx, dy) end,
