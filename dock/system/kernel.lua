...
function M.initialize(ctx)
  ...
  seed_file(paths.join(paths.etc, "services.json"), { autostart = { "devices", "notifications", "time", "ipc", "windows", "net" } })
  ...
  seed_file(paths.join(paths.etc, "permissions.json"), { permissions = { "fs.read", "fs.write", "fs.delete", "network.rednet", "peripheral.access", "settings.read", "settings.write", "process.spawn" } })
