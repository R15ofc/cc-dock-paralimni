...
function M.initialize(ctx)
  ...
  seed_file(paths.join(paths.etc, "services.json"), { autostart = { "devices", "notifications", "time", "ipc", "permissions", "app_runtime", "windows", "explorer", "cursor", "text_input", "menus", "studio", "updates", "net" } })
