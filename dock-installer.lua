...
local FILES = {
  ...
  "dock/system/explorer_service.lua", "dock/system/cursor_pack.lua", "dock/system/cursor_service.lua", "dock/system/text_input_service.lua", "dock/system/menu_service.lua",
  "dock/system/studio_service.lua", "dock/system/animation.lua", "dock/system/loading.lua", "dock/system/scrollbar.lua", "dock/system/splash.lua", "dock/system/update_service.lua", "dock/system/cloud_service.lua",
