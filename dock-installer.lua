...
local FILES = {
  ...
  "dock/system/explorer_service.lua", "dock/system/loading.lua", "dock/system/update_service.lua", "dock/system/shell_service.lua", "dock/system/kernel.lua", "dock/system/boot.lua",
