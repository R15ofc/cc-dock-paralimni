...
local FILES = {
  ...
  "dock/system/studio_service.lua", "dock/system/animation.lua", "dock/system/loading.lua", "dock/system/scrollbar.lua", "dock/system/splash.lua", "dock/system/update_service.lua",
